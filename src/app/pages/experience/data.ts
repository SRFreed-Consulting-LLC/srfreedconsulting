...
const contracts: JobContract [] = [
    {
        ...
        details:[
            'Drove the design and implementation of REST Endpoints used for Custom Training Software',
            ...
            'Augmented Enterprise Data Model as external systems were integrated into the back end architecture',
            'Designed and built API gateway and supporting documentation to allow Front End Team to interface with backend systems',
    ...
    },
    {
        ...
        description:"Served as a Senior Java Developer working on the Convergent Project for healthcare organizations to connect data and share information and insight.",
        details:[
            'Design and implemented Spring based Microservices, defined DAO models for new Microservices, and setup and built API gateway for Frontend integration',
            'Worked with different teams to better understand the Enterprise Data Model and Data Schema further develop their local node of the Enterprise Data Model and further develop their local node of the Enterprise Data Model',            'Built new or enhanced current Messaging handlers asynchronously receive and process messages from messaging service, access business rules for each transaction, and disposition of transactions.',
            'Built new or enhanced current Messaging handlers to asynchronously receive and process messages from the messaging service(Apache Camel), access business rules for each transaction, and disposition of transactions.',
    ...
    },
    {
        ...
        details: [
            ...
            'Augmented new and supported existing development of API Gateway endpoints',
            'Enhanced existing data model to allow for integration of more backend Finance Systems.',
            'Extended API Gateway to handle new Microservice endpoints and provide solid documentation for developers',
